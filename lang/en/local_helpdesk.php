...
$string['confirmdeleteticket'] = 'Are you sure you want to permanently delete the ticket "{$a}"? All responses and attachments related to this ticket will also be deleted.';
...
$string['deletesuccessticket'] = 'Ticket successfully deleted.';
$string['deleteticket'] = 'Delete ticket';
