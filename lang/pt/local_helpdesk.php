...
$string['category_role_description'] = 'Papel específico para controlar o acesso dos utilizadores à gestão de tickets.';
$string['category_users_all'] = 'Todos os utilizadores do Moodle';
$string['category_users_info'] = 'Primeiro, guarde a categoria antes de editar utilizadores.';
$string['category_users_responses'] = 'Utilizadores que respondem a esta categoria';
$string['category_users_title'] = 'Define os utilizadores com permissão para responder e que receberão um email sobre novos tickets';
$string['categoryadded'] = 'Categoria adicionada com sucesso';
$string['categorycreated'] = 'Categoria criada com sucesso';
$string['categorydeleted'] = 'Categoria eliminada com sucesso';
...
$string['confirmdeleteticket'] = 'Tem certeza de que deseja eliminar permanentemente o ticket "{$a}"? Todas as respostas e anexos relacionados com este ticket também serão eliminados.';
...
$string['deletesuccesscategory'] = 'Categoria eliminada com sucesso';
$string['deletesuccessticket'] = 'Ticket eliminada com sucesso.';
...
$string['errordeletecategory'] = 'Erro ao Eliminar Categoria';
...
$string['findcourse'] = 'Selecionar Disciplina';
$string['findticket'] = 'Pesquisar Assunto texto';
$string['finduser'] = 'Selecionar Utilizador';
...
$string['geniai_create_knowledgebase_desc'] = 'Descreva em detalhe o conteúdo que pretende gerar. O GeniAI utilizará esta informação para criar um texto preciso e relevante para a base de conhecimento.';
$string['geniai_create_knowledgebase_message'] = 'Crie uma mensagem com base no texto acima.';
$string['geniai_create_response_desc'] = 'Descreva o que pretende gerar. O GeniAI utilizará todas as conversas como base para criar uma resposta, mas precisa de definir quais dados pretende escrever.';
...
$string['helpdesk:categorydelete'] = 'Permite eliminar categorias.';
$string['helpdesk:categorymanage'] = 'Permite gerir as categorias do Helpdesk.';
$string['helpdesk:knowledgebase_delete'] = 'Eliminar artigos na base de conhecimento.';
$string['helpdesk:knowledgebase_manage'] = 'Gerir artigos na base de conhecimento.';
$string['helpdesk:knowledgebase_view'] = 'Ver artigos na base de conhecimento.';
$string['helpdesk:ticketmanage'] = 'Permite gerir o Helpdesk, incluindo responder e fechar tickets.';
$string['helpdesk:view'] = 'Permite ver tickets do Helpdesk e criá-los para si próprio.';
$string['helpdesk_manage_users'] = 'Ver utilizadores com permissão para gerir esta categoria de papel';
...
$string['knowledgebase_delete'] = 'Eliminar Base de conhecimento';
$string['knowledgebase_delete_confirm'] = 'Tem certeza de que deseja eliminar a base de conhecimento <strong>{$a}</strong>';
$string['knowledgebase_delete_success'] = 'Base de conhecimento eliminada com sucesso';
...
$string['knowledgebase_prompt_short'] = 'Prompt demasiado curto';
...
$string['privacy:metadata:category_user_userid'] = 'ID Utilizador - Categoria.';
$string['privacy:metadata:local_helpdesk_category_user'] = 'Utilizadores - Categorias Ticket.';
$string['privacy:metadata:local_helpdesk_response'] = 'respostas - Ticket.';
$string['privacy:metadata:local_helpdesk_ticket'] = 'Tickets - Utilizador, Categoria, Estado.';
$string['privacy:metadata:response_userid'] = 'ID Utilizador - resposta Ticket.';
$string['privacy:metadata:ticket_userid'] = 'ID Utilizador - Ticket.';
$string['replytoticket'] = 'resposta Ticket';
$string['report_assignment_reports_page_description'] = 'Relatório: Tickets / Utilizadores.';
...
$string['report_user_reports_avg_response_time_by_user_userid'] = 'ID Utilizador';
$string['report_user_reports_page_description'] = 'Relatório: Utilizadores Tickets.';
$string['report_user_reports_page_title'] = 'Relatórios Utilizadores';
$string['report_user_reports_users_with_most_tickets_open_cat_title'] = 'Utilizadores Tickets Aberto';
$string['savecategory'] = 'Guardar Categoria';
$string['savechanges'] = 'Guardar alterações';
$string['setting_course'] = 'Mostrar apenas dentro da disciplina';
...
$string['setting_menu_description'] = 'Selecione se pretende mostrar o menu HelpDesk no menu do sistema no topo do Moodle.';
